...
The application allows the user to select a feed, then displays a list of article titles from that feed.  When an article title in the list is clicked the full article is displayed in the browser.
